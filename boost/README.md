...
- `@boost/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@boost/db`: [Prisma](https://prisma.io/) ORM wrapper to manage & access your database
- `@boost/config-typescript`: `tsconfig.json`s used throughout the monorepo
